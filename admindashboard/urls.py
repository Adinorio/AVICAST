...
urlpatterns = [
    ...
    path('statistical-reports/', views.statistical_reports_view, name='statistical_reports'),
    path('api/statistical-reports/', views.statistical_reports_api, name='statistical_reports_api'),
]
