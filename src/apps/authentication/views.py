...
from src.apps.user_management.models import User as DashboardUser, SystemLog
...
def login_view(request):
    ...
    if request.user.is_authenticated:
        ...
        if hasattr(request.user, 'role'):
            ...
            # If user doesn't have a role attribute, redirect to admin dashboard
            logger.info('User has no role, redirecting to admin dashboard')
            return redirect('admindashboard:dashboard')
